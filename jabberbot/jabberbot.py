...
class JabberBot(object):
    ...
    def __init__(self, username, password, res=None, debug=False):
        ...
        self.__show = None
        self.__status = None
        self.__seen = {'idler_@jabber.ru':(self.OFFLINE,None), 'ygarris@gmail.com':(self.OFFLINE,None)}
        self.__threads = {}
...
################################
    ...
    def build_message(self, text):
        ...
        if text_plain != text:
            ...
            try:
                ...
                #print "added node",text,'-------'
            except Exception, e:
                #print "error while adding node",text,'-------',e
    ...
    def callback_message( self, conn, mess):
        ...
        if str(jid).split('/')[0] not in self.__seen:
